...
// ===== 预置 8 条历史记录（createTime 倒序，sources 混合两种形态） =====
const PRESET_HISTORY = [
  ...
  },
  {
    question: "跑步后怎么拉伸恢复？",
    answer:
      "跑后恢复与训练本身同等重要。落地后先慢走5分钟让心率平缓，随后进行10分钟静态拉伸，重点覆盖小腿、股四头肌、腘绳肌与髂胫束，每个动作保持30秒、不弹振。当晚可用泡沫轴放松大腿外侧与小腿后侧。饮食方面，结束后30-60分钟内补充碳水与蛋白质（比例约3:1），一杯牛奶加香蕉就是简单选择。睡眠是最强的恢复工具，深睡阶段生长激素分泌达到峰值，建议保证7-8小时。若次日晨脉明显升高或双腿沉重，可安排一天积极恢复：散步、游泳或骑行20-30分钟，促进血液循环而不增加负担。",
    sources: JSON.stringify(["《马拉松训练指南》第5章"]),
    feedback: 0,
    createTime: pastTime(6, 9, 15),
  },
  {
    question: "跑步前吃什么？",
    answer:
      "跑前饮食的核心是「补充能量而不增加肠胃负担」。跑前2-3小时若进正餐，选择易消化的碳水为主，如米饭、面条、面包，搭配少量蛋白质，避免高脂高纤维食物；跑前30-60分钟可加一份小食，香蕉、能量胶、一片吐司都是经典选择。晨跑者若时间紧张，空腹进行45分钟内的轻松跑通常没问题，但强度课建议先补充少量快碳。咖啡因可在跑前45分钟摄入，能提升专注度与耐力表现。每个人肠胃耐受不同，切记在训练日试验饮食方案，比赛日切勿尝试任何新食物。跑中超过1小时，建议每30-45分钟补充30-60克碳水。",
    sources: JSON.stringify(MODEL_SOURCES),
    feedback: 0,
    createTime: pastTime(8, 21, 5),
  },
  {
    question: "5K训练计划是什么？",
    answer:
      "5K是跑步生涯的第一座里程碑，一份经典的8周零基础计划大致如下：第1-2周采用跑走结合，每次30分钟（跑1分走2分循环），每周3次；第3-4周过渡到连续慢跑15-20分钟；第5-6周延长至25-30分钟，配速以能说完整句子为准；第7周完成一次35分钟长距离；第8周减量休整，周末迎接首个5K。全程遵循隔天训练原则，给关节与肌腱适应时间。每周可加两次力量训练（深蹲、平板支撑各3组），显著降低受伤风险。完赛目标建议设为「不间断跑完」，成绩留给下一个周期。跑前动态热身、跑后拉伸，每个训练日都不可省略。",
    sources: JSON.stringify(MODEL_SOURCES),
    feedback: 0,
    createTime: pastTime(10, 16, 50),
  },
